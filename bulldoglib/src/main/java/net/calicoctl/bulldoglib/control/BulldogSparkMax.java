...
/**
 * A wrapper class for {@link SparkMax}.
 ...
 */
public class BulldogSparkMax extends LoggableMotor {

    /**
     * The backing motor of the BulldogSparkMax.
    ...
    /**
     * Creates a new BulldogSparkMax with the given id, the given name, and the given config.
     ...
     */
    public BulldogSparkMax(int id, String name, SparkMaxConfig config, MotorType motorType, boolean useAbsoluteEncoder, boolean enableTuning) {
        super(name, id);
        super.setInputs(
            new LoggableInputs() {
    ...
    /**
     * Creates a copy of this BulldogSparkMax with the Follower config applied to the backing motor.
     ...
     * @return A copy of this BulldogSparkMax, following the motor at the given ID.
     * @throws IllegalArgumentException if the leaderID has the same id as the backing motor.
     */
    public BulldogSparkMax withLeader(int leaderID, boolean opposeLeader) {
    ...
    /**
     * Creates a copy of this BulldogSparkMax with the Follower config applied to the backing motor.
     * @param leaderMotor The BulldogSparkMax to follow.
     * @param opposeLeader {@code true} to oppose the output of the leader, {@code false} to align to the output of the leader.
     * @return A copy of this BulldogSparkMax, following the motor at the given ID.
     ...
     */
    public BulldogSparkMax withLeader(BulldogSparkMax leaderMotor, boolean opposeLeader) {
        return this.withLeader(Objects.requireNonNull(leaderMotor, "Cannot follow a null motor!").getID(), opposeLeader);
    }

    /**
     * Creates a copy of this BulldogSparkMax with the applied IdleMode config.
     * @param value {@code true} to enable brake mode, {@code false} to enable coast mode.
     * @return A copy of this BulldogSparkMax with the desired IdleMode config.
     */
    public BulldogSparkMax withBrakeMode(boolean value) {
        config.idleMode(value ? IdleMode.kBrake : IdleMode.kCoast);
        return this;
    }

    /**
     * Creates a copy of this BulldogSparkMax with the desired inverted config.
     * @param value {@code true} to invert the motor, {@code false} to uninvert the motor.
     * @return A copy of this BulldogSparkMax with the desired inverted config.
     */
    public BulldogSparkMax withInverted(boolean value) {
